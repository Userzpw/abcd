...
parser.add_argument('--missing_rate', type=float, default=0.3, help='缺失率 (0.0 - 0.9)')
...
parser.add_argument('--gpu', default='2', type=str, help='GPU device idx.')
...
if __name__ == "__main__":
    ...
    if args.db == "MSRCv1":
        ...
        # 数据量 50000，特征维度大，建议使用较小的学习率和较大的 Batch Size
        args.learning_rate = 0.0005
        args.batch_size = 5000  # 5万数据，Batch 设大点跑得快
        args.con_epochs = 100
        args.seed = 10
        args.normalized = True  # 开启归一化
